          ...
          <div className={styles.card}>
            ...
            <div className={styles.formGrid}>
              ...
              <div className={styles.formGroup}>
                ...
                <input className={styles.input} value={exam.type} onChange={(e) => updateExamField("type", e.target.value)} placeholder="e.g. JEE, NDA, UPSC" disabled={loading} />
              </div>
              <div className={styles.formGroup}>
                <label>Batch</label>
        ...
        {step === "preview" && parseResult && (
          <div>
            ...
            <p style={{ fontSize: "0.88rem", color: "#64748b", marginBottom: "12px" }}>
              Review the parsed questions below. The correct answer is highlighted in <span style={{ color: "#16a34a", fontWeight: 600 }}>green</span>.
            </p>
